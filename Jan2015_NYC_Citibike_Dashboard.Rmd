...
```{r}
scatterplot3d( x = NYCB$tripduration, y = NYCB$age, z = NYCB$distance,
               color="violetred4", main= "Distance vs. Age vs. Duration", 
               xlab="Trip Duration", ylab="Age", zlab="Distance", 
               cex.axis=.6, grid=T )
```
...
upper = "Stations"
bp <- barplot( five.start.station$n, beside = TRUE, 
               horiz = TRUE, border=NA, names="", col="palegreen3")

title( main = "Top 5 Frequently Used Start Stations")
title( xlab ="Customers/Subscribers", 
       col  = "palegreen3")
title( ylab = "Start Stations")
text( bp, lab = c("8 Ave & W ","Lafayette St & E", "E 43 St & Vanderbilt", 
                  "W 21 St & 6 Ave", "8 Ave & W 33 St" ), 
      pos=4)
...
```{r Heat Map Frequency by Age, echo=FALSE}
